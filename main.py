...
async def get_json_raw(request: Request,x_token_key: str = Header(...)):
    ...
    try:
        ...
        nombre_archivo = f"{folder_excel}\{trknum}.xlsx" 
        archivo        = f"Confirmación {trknum}.xlsx" 
        ...
        try:
          with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
             ...
             smtp.send_message(reply,from_addr= "dickainterfaces@gmail.com", to_addrs="garcia.miguel@dickalogistics.com.mx")             
